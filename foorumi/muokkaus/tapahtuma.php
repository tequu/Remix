...
if (tarkistaHallintaOikeudetKeskustelualueelle($yhteys, $keskustelualue)) {
    $kysely = kysely($yhteys, "SELECT otsikko, tapahtuma, UNIX_TIMESTAMP(alkamisaika) alkamisaika, UNIX_TIMESTAMP(loppumisaika) loppumisaika, kuvaus, UNIX_TIMESTAMP(ilmotakaraja) ilmotakaraja, 
        ...
        <div id="muokkaatapahtumaa">
            ...
            <div id="lomake">
                <form id="muokkaatapahtumaa-form" action="<?php echo $_SERVER['PHP_SELF'] . "?keskustelualue=" . $keskustelualue . "&keskustelu=" . $keskustelu . "&mode=tapahtuma"; ?>" method="post">
                    ...
                    <div id="oikea">
                        <input id="tekstikentta" type="text" name="nimi" value="<?php echo isset($_POST['nimi']) ? $_POST['nimi'] : $tulos['otsikko']; ?>" />
                    </div>
                    ...
                    <div id="oikea">
                        ...
                        <input type="radio" name="tapahtuma" value="turnaus"<?php echo $_POST['tapahtuma'] == "turnaus" || (!isset($_POST['tapahtuma']) && $tulos['tapahtuma'] == "turnaus") ? " CHECKED" : ""; ?> />Turnaus
                    ...
                    <div id="vasen"><input type="checkbox" name="maxilmoo" value="1"<?php echo($_POST['maxilmoo'] || (!isset($_POST['maxilmoo']) && $tulos['ilmomaxmaara']) ? " CHECKED" : ""); ?> />Ilmoittautujien maksimi määrä</div> 
                    <div id="oikea">
                    ...
                    <div id="vasen">Kuvaus (max. 120 merkkiä)</div> 
                    <div id="oikea">
                        <textarea id="tekstikentta" name="kuvaus" maxlength="120"><?php echo isset($_POST['kuvaus']) ? $_POST['kuvaus'] : $tulos['kuvaus']; ?></textarea>
                    </div>
                    <div id="vasen">Lisätieto</div> 
                    <div id="oikea">
                    ...
                    <div id="napit">
                        <div class="muokkaa laheta" data-form="muokkaatapahtumaa-form"></div><div class="takaisin liiku" data-url="keskustelu.php?<?php echo get_to_string(array("mode")); ?>"></div>
                    </div>
                </form>
            </div>
        </div>
    ...
    ?>
    Sinulla ei ole oikeuksia muokata tapahtumaa.
    <?php
}
?>