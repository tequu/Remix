...
$kysely = kysely($yhteys, "SELECT otsikko, viesti, tunnuksetID FROM viestit v, keskustelualuekeskustelut kk " .
        "WHERE v.keskustelutID=kk.keskustelutID AND v.keskustelutID='" . $keskustelu . "' AND keskustelualueetID='" . $keskustelualue . "'");
