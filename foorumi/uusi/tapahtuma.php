...
<div id="uusitapahtuma">
    ...
    <div id="lomake">
        <form id="uusitapahtuma-form" action="<?php echo $_SERVER['PHP_SELF'] . "?keskustelualue=" . $keskustelualue."&mode=tapahtuma"; ?>" method="post">
            ...
            <div id="vasen">Kuvaus</div> <div id="oikea"><textarea id="tekstikentta" name="kuvaus"><?php echo $_POST['kuvaus']; ?></textarea></div>
            ...
            <div id="napit">
                <div class="lisaa laheta" data-form="uusitapahtuma-form"></div><div class="tyhjenna"></div>
            </div>
        </form>
    </div>
</div>